...
Welcome to the [Giraldo Project](<[Giraldo Project](https://github.com/GiraldoNainggolan/mern-crm-erp)>) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/GiraldoNainggolan/mern-crm-erp/issues).
- make sure it is not work in progress here [pull requests](https://github.com/GiraldoNainggolan/mern-crm-erp/pulls).
- you can then [create an issue](https://github.com/GiraldoNainggolan/mern-crm-erp/issues/new/choose) with the following information:
...
Thank you for contributing to [Giraldo Project](https://github.com/GiraldoNainggolan/mern-crm-erp) 
